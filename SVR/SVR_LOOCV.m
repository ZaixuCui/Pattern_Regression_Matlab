function Prediction = SVR_LOOCV(Subjects_Data, Subjects_Scores, Covariates, Pre_Method, ResultantFolder)
%
% Subject_Data:
%           m*n matrix
...
for i = 1:Subjects_Quantity
    ...
    model = svmtrain(Training_scores, Training_data_final,'-s 3 -t 0');
    ...
    % predict test data
    [Predicted_Scores(i), ~, ~] = svmpredict(test_score, test_data_final, model);
