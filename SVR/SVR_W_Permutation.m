...
function SVR_W_Permutation(Data_Path, Scores, Perm_times_Range, ResultantFolder, Queue)
...
for i = 1:100
    ...
    pipeline.(Job_Name).command = 'W_Calculate_SVR_SGE(opt.para1, opt.para2, opt.para3, opt.para4)';
